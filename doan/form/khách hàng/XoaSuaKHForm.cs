...
namespace doan
{
    public partial class XoaSuaKHForm : Form
    {
        ...
        private void XoaSuaKHForm_Load(object sender, EventArgs e)
        {
            SqlCommand command = new SqlCommand("SELECT * FROM khachhang");
            dataGridViewXoaSuaKH.ReadOnly = true;
            dataGridViewXoaSuaKH.RowTemplate.Height = 30;
        ...
        private void dataGridViewXoaSuaKH_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
